...
export function PeriodSelector({ state, onChange }: PeriodSelectorProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      {/* Mode tabs */}
      <div className="glass flex items-center gap-0.5 p-1 rounded-xl">
        {(
          [
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none glass rounded-lg px-3 py-1.5 pr-7 text-xs text-white/80 font-medium cursor-pointer focus:outline-none focus:border-violet-500/50 hover:bg-white/[0.09] transition-colors"
            >
              {MONTH_NAMES.map((m, i) => {
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none glass rounded-lg px-3 py-1.5 pr-7 text-xs text-violet-300 font-semibold cursor-pointer focus:outline-none hover:bg-white/[0.09] transition-colors"
            >
              {AVAILABLE_YEARS.map((y) => (
